...
draft: false
tags: [left-hand-drive, right-hand-drive, compliance, ev-import, markets]
---
...
1. **Drive side** — is the car available in the right configuration for my market?
2. **Homologation** — can it be made road-legal (see [WVTA vs single-vehicle approval](/blog/wvta-vs-single-vehicle-approval/))?
3. **Charging** — does it charge on my market's standard (see [CCS2 vs GB/T](/blog/ccs2-vs-gbt-charging/))?
4. **Then** tariff and landed cost.
...
1. **"Is my target market LHD or RHD?"** — this is the first filter, before price.
2. **"Is this model produced in the RHD variant?"** — if your market is RHD, confirm the specific model exists in RHD.
3. **"Am I being offered a China-market LHD car for an RHD market?"** — a red flag; walk away or confirm it's the export RHD build.
4. **"Does the homologation route accept this configuration?"** — even LHD-to-LHD needs type or single-vehicle approval.
5. **"Is the charging inlet the export standard too?"** — drive side and charging standard usually change together on export builds.

## Frequently asked questions

**Can I import a LHD Chinese EV into the UK or Australia?**
Not for road registration. Both are RHD markets, so you need a right-hand-drive variant. Conversion is generally not viable.

**Which markets can a China-market LHD EV serve directly?**
Continental Europe and the Gulf (UAE, Saudi Arabia) — the LHD markets — subject to homologation.

**Do Chinese brands make RHD versions?**
Yes — most major brands (BYD, MG, GWM, and others) produce RHD export variants for the UK, Australia, and Japan. But the RHD lineup is a subset of each brand's full catalog.
